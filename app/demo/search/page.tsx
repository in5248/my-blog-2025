        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  입력과 동시에 검색 결과가 나타납니다. 빠르고 부드러운 검색
                  경험을 제공합니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  검색어가 포함된 부분을 시각적으로 강조하여 쉽게 찾을 수
                  있습니다.
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {Object.entries(categoryStats).map(([category, count]) => {
                    const categoryData = mockPosts.find(
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2 text-sm">
                  <div>
                    • <strong>키워드:</strong> "React", "JavaScript",
                    "TypeScript"
                  </div>
                  <div>
                    • <strong>기술명:</strong> "Next.js", "TailwindCSS"
                  </div>
                  <div>
                    • <strong>주제:</strong> "성능 최적화", "웹 개발"
                  </div>
                  <div>
                    • <strong>개념:</strong> "컴포넌트", "훅", "라우팅"
                  </div>
                </div>
              </CardContent>
            </Card>
