...
export const metadata: Metadata = {
  ...
  description:
    "RelatedPosts 컴포넌트의 다양한 기능을 테스트하는 데모 페이지입니다.",
};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            RelatedPosts 컴포넌트의 다양한 변형과 추천 알고리즘을 확인할 수 있는
            데모 페이지입니다. 동일 카테고리와 공통 태그를 기반으로 한 스마트
            추천 시스템을 체험해보세요.
          </p>
        </header>
        ...
        <section className="mb-12 p-6 bg-muted/30 rounded-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                <span className="font-medium">추천 포스트:</span>{" "}
        ...
        <section className="mb-16">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              표준 크기의 카드로 최대 3개의 관련 포스트를 표시합니다. 동일
              카테고리와 공통 태그를 기준으로 추천합니다.
            </p>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="border rounded-lg bg-card p-6">
            <p className="text-muted-foreground mb-4">
              이 부분은 일반적인 본문 텍스트이고, 아래에 인라인 관련 포스트가
              나타납니다:
            </p>
            <InlineRelatedPosts currentPost={currentPost} />
            <p className="text-muted-foreground mt-4">
              그리고 이어서 본문이 계속됩니다. 자연스럽게 본문 흐름에 맞게 관련
              포스트를 추천할 수 있습니다.
            </p>
          </div>
        </section>
